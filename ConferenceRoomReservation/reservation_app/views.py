...
class AddRoomView(View):
    ...
    def post(self, request):
        ...
        if not name:
            return render(request, 'reservation_app/add_room.html', context={"error": "Nie podano nawy sali"})
        if capacity <= 0:
